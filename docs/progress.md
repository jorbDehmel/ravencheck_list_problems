...
If verification time is blank, this problem has not been
finished.

 Problem file                 | File   | Lemmas | Verification time
------------------------------|--------|--------|-------------------
 ...
 nat_append_inj_1.smt2        | p25.rs |        |
 nat_append_inj_2.smt2        | p26.rs |        |
